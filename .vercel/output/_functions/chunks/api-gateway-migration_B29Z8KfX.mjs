...
const frontmatter = {
  ...
  "constraints": ["Cannot break existing client integrations", "Must migrate 50+ services without downtime", "Limited budget for commercial solutions", "6-week timeline"],
  ...
  "keyDecisions": [{
    ...
    "alternatives": ["AWS API Gateway", "Nginx with custom Lua scripts", "Envoy Proxy"]
  }, {
  ...
  "techStack": ["Kong", "Lua", "PostgreSQL", "Prometheus", "Grafana", "Kubernetes"],
  "impact": {
    "metrics": [{
  ...
  "learnings": ["Traffic splitting is essential for safe migrations at scale", "Investing in observability before migration pays off immediately", "Plugin-based architecture makes it easy to add new capabilities"],
  "featured": false,
  "order": 3,
  "relatedProjects": ["authentication-platform"],
  "relatedDecisions": ["feature-flags-system"]
};
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      ...
      children: "The phased rollout was critical to success. We started with low-traffic internal services to validate the approach, then gradually moved to higher-traffic customer-facing services."
    }), "\n", createVNode(_components.p, {
      children: "Each service migration followed a checklist: update routing rules, enable traffic splitting at 1%, monitor for 24 hours, increase to 10%, 50%, then 100%. This gave us confidence at each step."
    })]
  });
}
...
const url = "src/content/projects/api-gateway-migration.mdx";
const file = "C:/Users/laila/MyNewPortfolio/case/src/content/projects/api-gateway-migration.mdx";
...
Content.moduleId = "C:/Users/laila/MyNewPortfolio/case/src/content/projects/api-gateway-migration.mdx";
