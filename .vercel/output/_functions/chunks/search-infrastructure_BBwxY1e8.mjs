...
const frontmatter = {
  ...
  "constraints": ["Must index 2M+ products with real-time updates", "p99 latency must be under 200ms", "Budget constraints ruled out managed search services", "Team had no prior Elasticsearch experience"],
  ...
  "keyDecisions": [{
    ...
    "alternatives": ["Algolia managed search", "Apache Solr", "Meilisearch"]
  }, {
    ...
    "alternatives": ["Application-level dual writes", "Periodic batch reindexing"]
  }, {
  ...
  "techStack": ["Elasticsearch", "Python", "Debezium", "Kafka", "PostgreSQL", "Redis", "Kubernetes"],
  "impact": {
    "metrics": [{
  ...
  "learnings": ["Relevance tuning is an ongoing process, not a one-time setup—build tools for non-engineers to iterate", "CDC is powerful but adds operational complexity—invest in monitoring and alerting", "Search is a product, not just a feature—dedicate resources to continuous improvement", "Elasticsearch cluster management requires dedicated expertise"],
  "featured": false,
  "order": 4
};
function getHeadings() {
  return [{
    "depth": 2,
    "slug": "relevance-tuning-journey",
    "text": "Relevance Tuning Journey"
  }, {
    "depth": 2,
    "slug": "operational-lessons",
    "text": "Operational Lessons"
  }];
}
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      id: "relevance-tuning-journey",
      children: "Relevance Tuning Journey"
    }), "\n", createVNode(_components.p, {
      children: "The initial Elasticsearch deployment actually performed worse than the PostgreSQL search for some queries. We spent significant time tuning BM25 parameters, field boosting, and function scores."
    }), "\n", createVNode(_components.p, {
      children: "The breakthrough came when we incorporated click-through data into relevance scoring. Products that users actually clicked on after searching got boosted, creating a feedback loop that continuously improved results."
    }), "\n", createVNode(_components.h2, {
      id: "operational-lessons",
      children: "Operational Lessons"
    }), "\n", createVNode(_components.p, {
      children: "Running Elasticsearch at scale taught us a lot about JVM tuning, shard management, and cluster topology. We had several incidents early on due to GC pauses and unbalanced shards. Building comprehensive monitoring and runbooks was essential."
    })]
  });
}
...
const url = "src/content/projects/search-infrastructure.mdx";
const file = "C:/Users/laila/MyNewPortfolio/case/src/content/projects/search-infrastructure.mdx";
...
Content.moduleId = "C:/Users/laila/MyNewPortfolio/case/src/content/projects/search-infrastructure.mdx";
